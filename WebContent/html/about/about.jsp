...
<div id="acerca">
    <div id="cabecera">
      <div id="centro">
        <div id="texto">
          <h1>Bienvenido a GZone</h1>
          <p>Una nueva manera de guardar tus juegos</p>
          <p>Descarga tus juegos favoritos en cualquier momento. Desde donde sea.</p>
          <p>¡Únete a GZone y descubre miles de juegos nuevos cada día!</p>
        </div>
    ...
    <div id="cabecera2">
      <div id="centro2">
        <div id="texto">
          <h1>¿Y bien? ¿A qué diablos estás esperando?Únete hoy a GZone y obtén acceso a muchas más características.</h1>
        </div>
      </div>
    </div>
 </div>
